    ...
    <>
     <Box sx={{ display:"flex", '@media screen and (max-width: 600px)': { display:"none"} }} >
        <Card sx={{ width:"227px", height:"330px", m:"0.3rem" }}>
            ...
            <CardContent>
                <Typography sx={{fontFamily:"sans-serif" }} aria-label="Medium sizes" gutterBottom component="div">
            ...
            <CardActions sx={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <Button size="small" sx={{height:"1.5rem", backgroundColor: "pink", border: "1px solid white", color:"white", mr:".7rem", boxShadow: 3  }}>Contact</Button>
            </CardActions>
        </Card>

       </Box>  
        
       <Box sx={{height:"200px", width:"125px", mr:".5rem" ,'@media screen and (min-width: 600px)': { display:"none" } }} >
